...
if ($arResult['SHOW_ERRORS'] == 'Y' && $arResult['ERROR']) ShowMessage($arResult['ERROR_MESSAGE']);
    ...
    if($arResult["FORM_TYPE"] == "login"):?>
        ...
        <span class="hd_singin">
            ...
            <div class="hd_loginform">
                <form name="system_auth_form<?=$arResult["RND"]?>" method="post" target="_top" action="<?=$arResult["AUTH_URL"]?>">
                    ...
                    <input type="text" name="USER_LOGIN" value="" placeholder="<?=GetMessage("AUTH_LOGIN")?>" />
                    <script>
                        BX.ready(function() {
        ...
        <br>
        <?if($arResult["NEW_USER_REGISTRATION"] == true):?>
        <noindex>
                ...
                <form name="system_auth_form<?=$arResult["RND"]?>" method="post" target="_top" action="<?=$arResult["AUTH_URL"]?>">
                    ...
                    <table width="95%">
                        ...
                        <tr>
                            <td colspan="2">
                                <noindex>
                                    <a href="<?=$arResult["AUTH_LOGIN_URL"]?>" rel="nofollow"><?echo GetMessage("auth_form_comp_auth")?></a>
                                </noindex><br />
                            </td>
                        </tr>
                    </table>
    ...
    <?else:?>
        ...
        <span class="hd_sing">
            <?=$arResult["USER_NAME"]?> [<a href="<?=$arResult["PROFILE_URL"]?>" title="<?=GetMessage("AUTH_PROFILE")?>">
